...
class FoodDaoTest {
    ...
    private var food1 = Food("1", "15-minute chicken & halloumi burgers", "https://www.themealdb.com/images/media/meals/vdwloy1713225718.jpg", false, "Chicken")
    private var food2 = Food("2", "Chick-Fil-A Sandwich", "https://www.themealdb.com/images/media/meals/sbx7n71587673021.jpg", true, "Chicken")
    ...
    fun daoInsert_InsertOneFoodIntoDb() = runBlocking {
        addOneFoodToDb()
    ...
    @Test
    @Throws(Exception::class)
    fun daoGetFoodCategory_returnsAllFoodsByCategoryFromDB() = runBlocking {
        addTwoFoodsToDb()
        val allItems = foodDao.getFoodCategory("Chicken").first()
        Assert.assertEquals(allItems[0].asDomainFoodObject(), food1)
    ...
    @Test
    @Throws(Exception::class)
    fun daoGetItem_returnsOneFoodItemByIdFromDB() = runBlocking {
        addTwoFoodsToDb()
    ...
    @Test
    @Throws(Exception::class)
    fun daoGetFavourites_returnsFavouriteFoodsFromDB() = runBlocking {
        addTwoFoodsToDb()
    ...
    @Test
    @Throws(Exception::class)
    fun daoSetFavourite_SetFoodToFavourite() = runBlocking {
        addOneFoodToDb()
